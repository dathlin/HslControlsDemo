...
{
    partial class FormCurveHistory8
	{
        /// <summary>
        ...
        {
			HslControls.ReferenceAxis referenceAxis1 = new HslControls.ReferenceAxis();
			...
			this.hslCurveHistory1.HoverDateTimeWidth = 150;
			this.hslCurveHistory1.LeftWidth = 45;
			...
			referenceAxis1.Max = 1000F;
			referenceAxis1.Unit = "m/s";
			this.hslCurveHistory1.ReferenceAxis.Add(referenceAxis1);
			this.hslCurveHistory1.Size = new System.Drawing.Size(980, 515);
			...
			this.label6.Text = "多轴的操作分为两个部分，一，添加轴信息，修改属性 ReferenceAxis ，添加轴信息\r\n二，在代码里设置曲线时，使用设置自定义轴索引的方法，索引 0 表示左" +
    "轴，索引 1 表示右轴，2 以上是自定义轴，按顺序";
			// 
			// FormCurveHistory8
			// 
