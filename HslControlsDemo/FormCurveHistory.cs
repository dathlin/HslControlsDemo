...
namespace HslControlsDemo
{
	public partial class FormCurveHistory : FormContent
	{
		...
		private void HslCurveHistory1_onCurveRangeSelect( HslControls.HslCurveHistory hslCurve, HslControls.HslMarkForeSection foreSection )
		{
			...
			//hslCurve.RenderCurveUI( foreSection.StartIndex, foreSection.EndIndex );
		}
		...
		private void button4_Click_1( object sender, EventArgs e )
		{
			try
			{
				...
				{
					hslCurveHistory1.ScrollToIndex( int.Parse( textBox3.Text ) );
				}
				else
				{
					hslCurveHistory1.ScrollToDateTime( DateTime.Parse( textBox3.Text ) );
				}
			}
			catch (Exception ex)
			{
