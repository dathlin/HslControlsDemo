...
namespace HslControlsApp
{
    ...
    public class MainActivity : AppCompatActivity, NavigationView.IOnNavigationItemSelectedListener
    {
        ...
        private void CheckServer( )
        {
            ...
            HslCommunication.OperateResult<HslCommunication.NetHandle, string> read = simplifyClient.ReadCustomerFromServer( 101, "2.2.9" );
        }
        ...
        public bool OnNavigationItemSelected(IMenuItem item)
        {
            ...
            else if (id == Resource.Id.nav_HslSignature)
            {
                Intent i = new Intent( this, typeof( Activity_HslSignature ) );
                this.StartActivity( i );
            }
            else if (id == Resource.Id.nav_HslBagFilter)
            {
